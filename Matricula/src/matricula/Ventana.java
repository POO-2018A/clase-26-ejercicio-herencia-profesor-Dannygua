...
public class Ventana extends javax.swing.JFrame {
    ...
    ArrayList <Profesores> listaP = new ArrayList <Profesores>();
    ...
    public Ventana() {
        ...
        String TituloMaterias []= new String []{"Materias"};
    ...
    private void btnIngresarMateriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarMateriaActionPerformed
        ...
        if (!txtIngresarMateria.getText().equals("")){
        repetido =true;
        Materias newMaterias = new Materias (txtIngresarMateria.getText());
        listaMaterias.add(newMaterias);
